...
//��ע΢�Ź���ƽ̨΢�źţ�"����ԭ��"����ѻ�ȡFPGA & ZYNQ & STM32���ϡ�
//��Ȩ���У�����ؾ���
//Copyright(C) ����ԭ�� 2018-2028
//All rights reserved
//----------------------------------------------------------------------------------------
// File name:           main.c
// Last modified Date:  2019��5��22������10:27:03
// Last Version:        V1.0
// Descriptions:        Axi dma�����������ж�ģʽ�´������ݰ����÷�ʾ��
//----------------------------------------------------------------------------------------
// Created by:          ����ԭ��
// Created date:        2019��5��22������10:27:03
// Version:             V1.0
...
#define TEST_START_VALUE        0x0      //Start Value of Test
#define MAX_PKT_LEN             0x100    //Packet Length
